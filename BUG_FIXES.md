...
**Root Cause**: 
- `.env` file contained production URL: `REACT_APP_BACKEND_URL=https://portable-config-ui.preview.emergentagent.com`
...
- **Frontend Environment Files**:
  ...
  REACT_APP_BACKEND_URL=https://portable-config-ui.preview.emergentagent.com
  ```
