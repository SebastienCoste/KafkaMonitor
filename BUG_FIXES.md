...
**Root Cause**: 
- `.env` file contained production URL: `REACT_APP_BACKEND_URL=https://trace-blueprint.preview.emergentagent.com`
...
- **Frontend Environment Files**:
  ...
  REACT_APP_BACKEND_URL=https://trace-blueprint.preview.emergentagent.com
  ```
