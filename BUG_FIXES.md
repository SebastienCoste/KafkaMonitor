...
**Root Cause**: 
- `.env` file contained production URL: `REACT_APP_BACKEND_URL=https://real-flow-viewer.preview.emergentagent.com`
...
- **Frontend Environment Files**:
  ...
  REACT_APP_BACKEND_URL=https://real-flow-viewer.preview.emergentagent.com
  ```
