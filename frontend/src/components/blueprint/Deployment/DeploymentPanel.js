        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p><strong>Validate:</strong> Check if the blueprint is valid without deploying</p>
              <p><strong>Activate:</strong> Deploy the blueprint to the selected environment</p>
            </div>
          </div>
        </CardContent>
      </Card>
