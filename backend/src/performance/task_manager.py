"""
Async Task Manager - Phase 1: Critical Memory & Task Fixes
...
class AsyncTaskManager:
    ...
    def __init__(self, max_concurrent: int = 20):
        ...
        logger.info(f"✅ AsyncTaskManager initialized with {max_concurrent} max concurrent tasks")
    ...
    def _start_cleanup_monitor(self):
        ...
        try:
            ...
            # Event loop might not be running yet during initialization
            logger.debug("Task monitor will be started when event loop is available")
